...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.persistentstorage.provider";
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)){
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.persistentstorage.provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.persistentstorage.provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.persistentstorage.provider.category";
            case CATEGORY_ITEM:
                return "vnd.android,cursor.item/vnd.com.example.persistentstorage.provider.category";
        }
        return null;
    }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)){
            case BOOK_DIR:
                updateRow = database.update("Book",values,selection,selectionArgs);
                break;
            case BOOK_ITEM:
                String bookId = uri.getPathSegments().get(1);
                updateRow = database.update("Book",values,"id=?",new String[]{bookId});
                break;
            case CATEGORY_DIR:
            ...
            case CATEGORY_ITEM:
                String categoryId = uri.getPathSegments().get(1);
                updateRow = database.update("Category",values,"id=?",new String[]{categoryId});
                break;
            default:
                break;
        }
